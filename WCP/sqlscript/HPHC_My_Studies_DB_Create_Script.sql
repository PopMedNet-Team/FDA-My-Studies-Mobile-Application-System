...
CREATE DATABASE IF NOT EXISTS `fda_hphc` /*!40100 DEFAULT CHARACTER SET latin1 */;
USE `fda_hphc`;
...
) ENGINE=InnoDB AUTO_INCREMENT=6801 DEFAULT CHARSET=utf8;
...
) ENGINE=InnoDB AUTO_INCREMENT=22051 DEFAULT CHARSET=utf8;
...
DELIMITER //
CREATE DEFINER=`fdahphc`@`%` PROCEDURE `deleteInActiveActivity`(studyId INT(11))
BEGIN
...
DELIMITER //
CREATE DEFINER=`fdahphc`@`%` PROCEDURE `deleteQuestionnaire`(questionnaireId INT(11),modifiedOn VARCHAR(255),modifiedBy INT(11),studyId INT(50))
BEGIN
...
DELIMITER //
CREATE DEFINER=`fdahphc`@`%` PROCEDURE `deleteQuestionnaireFrequencies`(questionnaireId INT(11))
BEGIN
...
DELIMITER //
CREATE DEFINER=`fdahphc`@`%` PROCEDURE `deleteQuestionnaireStep`(questionnaireId INT(11),modifiedOn VARCHAR(255),modifiedBy INT(11),sequenceNo INT(11),stepId INT(11),steptype VARCHAR(255))
BEGIN
...
CREATE TABLE IF NOT EXISTS `form_mapping` (
  ...
  `active` tinyint(1) DEFAULT '1',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=38125 DEFAULT CHARSET=utf8;
...
CREATE TABLE IF NOT EXISTS `instructions` (
  ...
  `status` tinyint(4) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=6125 DEFAULT CHARSET=utf8;
...
) ENGINE=InnoDB AUTO_INCREMENT=10818 DEFAULT CHARSET=utf8;
...
) ENGINE=InnoDB AUTO_INCREMENT=13259 DEFAULT CHARSET=utf8;
...
) ENGINE=InnoDB AUTO_INCREMENT=59417 DEFAULT CHARSET=utf8;
...
CREATE TABLE IF NOT EXISTS `questions` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=83930 DEFAULT CHARSET=latin1;
...
) ENGINE=InnoDB AUTO_INCREMENT=10292 DEFAULT CHARSET=utf8;
...
) ENGINE=InnoDB AUTO_INCREMENT=151876 DEFAULT CHARSET=latin1;
...
) ENGINE=InnoDB AUTO_INCREMENT=83693 DEFAULT CHARSET=latin1;
...
) ENGINE=InnoDB AUTO_INCREMENT=7295 DEFAULT CHARSET=latin1;
...
-- Dumping data for table fda_hphc.roles: ~2 rows (approximately)
...
INSERT INTO `users` (`user_id`, `first_name`, `last_name`, `email`, `password`, `phone_number`, `role_id`, `created_by`, `created_date`, `modified_by`, `modified_date`, `status`, `access_code`, `accountNonExpired`, `accountNonLocked`, `created_date_time`, `credentialsNonExpired`, `modified_date_time`, `password_expairded_datetime`, `security_token`, `token_expiry_date`, `token_used`, `force_logout`, `user_login_datetime`) VALUES
	(1, 'Account', 'Manager', 'superadmin@gmail.com', '$2a$10$u9g0amp4vMlEZrfnfH/hBeqXZx9psguQeMb4nzIn798MF2/L51HTi', '333-333-3355', 1, 1, '2018-01-18 14:36:41', 47, '2018-01-18 15:42:55', 1, 'ja67Ll', 1, 1, NULL, 1, NULL, '2020-12-09 10:32:48', 'N8K7zYrc0F', '2020-06-07 19:01:14', 0, 'N', '2018-01-25 19:01:14');
